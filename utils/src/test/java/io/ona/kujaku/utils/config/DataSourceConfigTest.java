...
public class DataSourceConfigTest {
    ...
    public void testToJsonObject() throws JSONException, InvalidMapBoxStyleException {
        ...
        Assert.assertEquals(config1.toJsonObject().toString(), object1.toString());
    ...
    public void testExtractDataSourceNames() throws InvalidMapBoxStyleException {
        ...
        Assert.assertEquals(DataSourceConfig.extractDataSourceNames(new ArrayList<DataSourceConfig>()).length, 0);
        ...
        Assert.assertEquals(names1.length, size1);
        // Assert the order of names
        for (int i = 0; i < names1.length; i++) {
            Assert.assertEquals(names1[i], String.valueOf(i));
        }
    }
}